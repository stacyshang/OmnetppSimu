...
class FivePortRouting : public cSimpleModule{
    private:
       int myAddress;
...
Define_Module(FivePortRouting);

void FivePortRouting::initialize(){
    myAddress = (int)getParentModule()->par("lrid")+10000;
...
void FivePortRouting::handleMessage(cMessage *msg){
